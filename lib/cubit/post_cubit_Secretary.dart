...
import 'post_state_Secretary.dart';
  ...
  Future<void> fetchAppointments({bool initialLoad = true}) async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse("$baseUrl/todaysAppointments?page=$_page&limit=$_limit"),
        headers: {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['appointments'] != null) {
          ...
          emit(
              PostLoadedDoctor(allAppointments, hasReachedMax: _hasReachedMax));
        } else {
